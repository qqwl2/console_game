...
public:
  ...
  virtual void panel_module_purchase(const int energy_cost, const int bits_cost) = 0;
  virtual void panel_robot_purchase(const int energy_cost, const int bits_cost) = 0;
